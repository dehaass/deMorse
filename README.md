...
## TODO
- Add power control to onboard expressLRS Rx
- Implement gamepad mode to use with expressLRS controller
- Finish implementing all commands
- Link Google Doc and AutoHotkey scripts to project
- Document
- Add dynamic morse timing 
- Implement iambic input option
- Expand microcontroller options
- Touch input on Teensy?
- Buzzer output options
